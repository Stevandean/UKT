                    ...
                    <div className="min-h-full bg-darkBlue p-6">
                        ...
                        <div className="flex justify-between items-center text-white mb-7">
                            ...
                            <div className="flex justify-center items-center gap-x-3">
                                ...
                                <h1 className='text-2xl tracking-wider'>Rekap Nilai - {dataEvent.name}</h1>
                            </div>
                        ...
                        <div className="bg-navy rounded-md py-2 px-3 uppercase">
                            ...
                            <table className='w-full table-fixed'>
                                <thead>
                                    <tr className='text-green text-center'>
                                        <th className='py-3 w-[5%]'>Rank</th>
                                        <th className='py-3 w-[5%]'>Tingkatan</th>
                                        <th className='w-[30%]' >Nama <button className='mx-3 rounded-md bg-gray text-xl' onClick={() => setModalFilter(true)}>⌃</button></th>
                                        <th className='w-[10%]'>Ranting</th>
                                        <th className='text-xs'>KESHAN {jenis == 'keshan' && updown == 'upToDown'
                                        ...
                                        <th className='text-xs'>Senam {jenis == 'senam' && updown == 'upToDown'
                                                ? <button className='rounded-md bg-gray text-lg' onClick={() => {
                                                    setJenis('senam');
                                                    setUpDown('downToUp');
                                                }}>⌄</button>
                                        ...
                                        <th className='text-xs'>Jurus {jenis == 'jurus' && updown == 'upToDown'
                                            ? <button className='rounded-md bg-gray text-lg' onClick={() => {
                                                setJenis('jurus');
                                                setUpDown('downToUp');
                                            }}>⌄</button>
                                        ...
                                        <th className='text-xs'>Fisik {jenis == 'fisik' && updown == 'upToDown'
                                                ? <button className='rounded-md bg-gray text-lg' onClick={() => {
                                                    setJenis('fisik');
                                                    setUpDown('downToUp');
                                                }}>⌄</button>
                                        ...
                                        <th className='text-xs'>Teknik {jenis == 'teknik' && updown == 'upToDown'
                                                ? <button className='rounded-md bg-gray text-lg' onClick={() => {
                                                    setJenis('teknik');
                                                    setUpDown('downToUp');
                                                }}>⌄</button>
                                        ...
                                        <th className='text-xs w-[10%]'>Sambung {jenis == 'sambung' && updown == 'upToDown'
                                                ? <button className='rounded-md bg-gray text-lg' onClick={() => {
                                                    setJenis('sambung');
                                                    setUpDown('downToUp');
                                                }}>⌄</button>
                                        ...
                                        <th className='text-xs'>Rerata {jenis == 'all' && updown == 'upToDown'
                                                ? <button className='rounded-md bg-gray text-lg' onClick={() => {
                                                    setJenis('all');
                                                    setUpDown('downToUp');
                                                }}>⌄</button>
                                ...
                                <tbody>
                                    {dataUkt.map((item, index) => (
                                        <tr className={index < 50 ? 'text-white text-center even:bg-darkBlue border-t border-gray-100' : 'text-white text-center bg-red border-t border-gray-100'}>
                                            ...
                                            <td className='border-b-2 border-gray'>{formatNumber(item.senam)}</td>
                                            <td className='border-b-2 border-gray'>{formatNumber(item.jurus)}</td>
                                            <td className='border-b-2 border-gray'>{formatNumber(item.fisik)}</td>
                                            <td className='border-b-2 border-gray'>{formatNumber(item.teknik)}</td>
                                            <td className='border-b-2 border-gray'>{formatNumber(item.sambung)}</td>
                                            <td className='border-b-2 border-gray'>{((item.keshan + item.senam + item.jurus + item.fisik + item.teknik + item.sambung) / 6).toLocaleString('id', { minimumFractionDigits: 1, maximumFractionDigits: 2 })}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
...
export default rekap_nilai_ukt_putih