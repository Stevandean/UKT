            ...
            <div className="w-full overflow-y-auto h-screen">
                ...
                <div className="min-h-full bg-darkBlue p-6">
                    ...
                    <div className="flex justify-between items-center text-white mb-7">
                        ...
                        {/* download button */}
                        <div className="bg-purple rounded-md px-5 py-2 flex items-center gap-x-2 w-48 justify-center">
                    ...
                    <div className="flex justify-between mb-7">
                        ...
                        <div id='animationElement' className="grid grid-cols-3 gap-x-8 text-white">
                            ...
                            <div className="inline-flex items-center gap-x-2">
                                <div className="bg-yellow h-5 w-5"></div>
                                <h1 className='text-lg font-semibold'>Baik</h1>
                            </div>
                            <div className="inline-flex items-center gap-x-2">
                                <div className="bg-green h-5 w-5"></div>
                    ...
                    <div className="bg-navy p-7 rounded-lg space-y-8 mb-8">
                        <div className="text-white text-3xl font-semibold tracking-wider text-center mb-6 uppercase">
                            Ranting Trenggalek
                        </div>
                        {data.map((item, index) => (
