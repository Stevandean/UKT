                    ...
                    <div className="relative w-full h-full max-w-2xl md:h-auto">
                        ...
                        <div className="relative bg-navy text-white rounded-lg shadow">
                            ...
                            <div className="flex items-center justify-end p-6 space-x-2">
                                ...
                                <button onClick={props.onDelete} className="text-white hover:text-green bg-green hover:bg-white duration-300 rounded-lg font-medium px-5 py-2.5 focus:z-10">Yes</button>
                            </div>
                        </div>
                    </div>
                </div>
...
export default modal_Soal_delete