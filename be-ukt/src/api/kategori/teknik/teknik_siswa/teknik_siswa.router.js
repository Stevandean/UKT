...
const {
    ...
    controllerGetByDetail,
} = require('./teknik_siswa.controller');
...
router.get('/ukt/:id', Auth, verifyRoles("admin", "super admin", "admin ranting", "admin cabang", "pengurus cabang", "pengurus ranting", "penguji cabang", "penguji ranting"), controllerGetByDetail)
